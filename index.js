...
app.get('/times', (req, res) => {
    res.send
        ...
        <body>
<section class="intro" style="background-image:url('images/soccer-488700_1280.jpg'); background-size:cover; background-position:center;">  <div class="mask d-flex align-items-center h-100 gradient-custom">
    <div class="container">
